...
export const DashboardView: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-6 space-y-6 max-w-7xl mx-auto pb-16">
      {/* Top Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 md:p-6 rounded-2xl border border-[#e0ecf4] shadow-xs">
        <div>
          <div className="flex items-center gap-2 text-xs font-semibold text-[#0e5d84] uppercase tracking-wider mb-1">
            ...
            <span className="text-emerald-700 font-bold lowercase text-[11px]">live system</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 bg-[#f0f7fb] hover:bg-[#dbeafe] text-[#0e5d84] border border-[#cbe0ec] text-xs font-semibold px-3 py-2 rounded-xl transition-colors"
          >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 md:gap-4">
        ...
        >
          <div className="flex items-center justify-between text-xs text-[#777587]">
            ...
            <span className="material-symbols-outlined text-base text-[#0e5d84]">school</span>
          </div>
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">2,486</div>
        ...
        <div
          ...
          className="bg-white p-4 rounded-xl border border-[#e0ecf4] shadow-xs hover:border-emerald-500 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between text-xs text-[#777587]">
          ...
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">94.6%</div>
            <div className="text-[10px] text-[#464555] mt-0.5">
        ...
        <div
          ...
          className="bg-white p-4 rounded-xl border border-[#e0ecf4] shadow-xs hover:border-teal-500 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between text-xs text-[#777587]">
          ...
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">₹18.4L</div>
        ...
        <div
          ...
          className="bg-white p-4 rounded-xl border border-[#e0ecf4] shadow-xs hover:border-amber-500 transition-all cursor-pointer group flex flex-col justify-between"
        >
          <div className="flex items-center justify-between text-xs text-[#777587]">
          ...
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">126</div>
        ...
        >
          <div className="flex items-center justify-between text-xs text-[#777587]">
            ...
            <span className="material-symbols-outlined text-base text-[#0e5d84]">co_present</span>
          </div>
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">168 / 174</div>
        ...
        >
          ...
          <div className="mt-2">
            <div className="text-xl md:text-2xl font-bold font-display text-[#082b3d]">₹32.8L</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-[#777587]">Biometric Turnstiles & Bus RFID sync today</p>
            </div>
          ...
          <div className="h-44 w-full relative flex items-end">
            <svg className="w-full h-full overflow-visible" viewBox="0 0 500 150" preserveAspectRatio="none">
              ...
              <line x1="0" y1="70" x2="500" y2="70" stroke="#f1f5f9" strokeDasharray="3" />
              <line x1="0" y1="110" x2="500" y2="110" stroke="#f1f5f9" strokeDasharray="3" />
              {/* Shaded Area */}
              <path
              ...
              <path
                ...
                strokeLinecap="round"
              />
              <circle cx="300" cy="20" r="4.5" fill="#0d9488" stroke="#ffffff" strokeWidth="2" />
            </svg>
          </div>
          <div className="flex justify-between text-[11px] text-[#777587] font-mono border-t border-[#f1f5f9] pt-2">
        ...
        <div className="lg:col-span-5 bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-sm font-bold text-[#082b3d] flex items-center gap-2">
                <span className="material-symbols-outlined text-[#0e5d84] text-base">filter_alt</span>
                <span>Admissions Funnel (AY 2025-26)</span>
              </h2>
              <p className="text-xs text-[#777587]">Pipeline conversion velocity</p>
            </div>
            <button
              onClick={() => setAdminView('admissions')}
              className="text-xs text-[#0e5d84] hover:underline font-semibold"
            >
              View Pipeline →
            </button>
          </div>
          ...
          <div className="space-y-2.5 text-xs">
            ...
            {/* Step 5: Rejected */}
            <div className="pt-1 flex items-center justify-between text-[11px] text-[#777587]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-6 bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-sm font-bold text-[#082b3d] flex items-center gap-2">
              ...
              <p className="text-xs text-[#777587]">Term 3 dual-entry fee accounts ledger</p>
            </div>
            <button
              onClick={() => setAdminView('fees')}
              className="text-xs text-[#0e5d84] hover:underline font-semibold"
          ...
          <div className="space-y-1.5 pt-1">
            <div className="text-[11px] font-semibold text-[#464555]">Monthly Inflow Trend (₹ Lakhs)</div>
            <div className="flex items-end justify-between h-20 gap-2 text-[10px] text-center pt-2">
              {[
                ...
                <div key={b.month} className="flex-1 flex flex-col items-center h-full justify-end">
                  <span className="text-[9px] text-[#777587] font-mono mb-1">{b.label}</span>
                  <div
                    className="w-full bg-[#0e5d84] rounded-t-md transition-all hover:bg-teal-600"
                    style={{ height: `${(b.val / 70) * 100}%` }}
                  ></div>
                  <span className="mt-1 font-semibold text-[#464555]">{b.month}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="lg:col-span-6 bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-4">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-sm font-bold text-[#082b3d] flex items-center gap-2">
                <span className="material-symbols-outlined text-[#0e5d84] text-base">grade</span>
                <span>Academic Performance (CBSE Pre-Board)</span>
              </h2>
              <p className="text-xs text-[#777587]">Class aggregate & subject pass benchmark</p>
            </div>
          ...
          <div className="space-y-3 text-xs">
            <div className="space-y-1">
              <div className="flex justify-between font-semibold">
                ...
                <span className="font-mono text-[#0e5d84] font-bold">91.2% Aggregate • 0 Failures</span>
              </div>
              <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-[#0e5d84] rounded-full w-[91%]"></div>
              </div>
            </div>
            ...
            <div className="space-y-1">
              <div className="flex justify-between font-semibold">
                ...
                <span className="font-mono text-[#0e5d84] font-bold">87.5% Aggregate • 0 Failures</span>
              </div>
              <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                <div className="h-full bg-[#0e5d84] rounded-full w-[87%]"></div>
              </div>
            </div>

            <div className="pt-2 grid grid-cols-4 gap-2 text-center text-[10px]">
              <div className="p-2 bg-slate-50 rounded-lg">
                <div className="text-[#777587]">Maths</div>
                <div className="font-bold text-[#082b3d] text-xs">92%</div>
              </div>
              <div className="p-2 bg-slate-50 rounded-lg">
                <div className="text-[#777587]">Physics</div>
                <div className="font-bold text-[#082b3d] text-xs">88%</div>
              </div>
              <div className="p-2 bg-slate-50 rounded-lg">
                <div className="text-[#777587]">English</div>
                <div className="font-bold text-[#082b3d] text-xs">94%</div>
              </div>
              <div className="p-2 bg-slate-50 rounded-lg">
                <div className="text-[#777587]">Chemistry</div>
                <div className="font-bold text-[#082b3d] text-xs">85%</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-3">
          <div className="flex items-center justify-between border-b border-[#f0f7fb] pb-2">
            <h3 className="text-xs font-bold text-[#082b3d] uppercase tracking-wider flex items-center gap-1.5">
              <span className="material-symbols-outlined text-sm text-[#0e5d84]">schedule</span>
              <span>Today's Schedule</span>
            </h3>
            <span className="text-[10px] font-mono text-[#0e5d84] font-bold bg-[#f0f7fb] px-1.5 py-0.5 rounded">
              ...
              <div
                ...
                className={`p-2.5 rounded-xl border transition-all cursor-pointer flex items-center justify-between ${
                  selectedPeriod === item.p
                    ? 'bg-[#f0f7fb] border-[#0e5d84] text-[#0e5d84]'
                    : 'border-[#f1f5f9] hover:bg-slate-50'
                }`}
              >
                <div>
                  <div className="font-bold">{item.subject}</div>
                  <div className="text-[10px] text-[#777587]">{item.teacher} • {item.room}</div>
                </div>
          ...
          <div className="space-y-2 text-xs">
            {approvals.map(app => (
              <div key={app.id} className="p-2.5 bg-slate-50 rounded-xl border border-slate-100 space-y-1">
                ...
                <p className="text-[11px] text-[#464555]">{app.details}</p>
                {app.status === 'pending' ? (
        ...
        <div className="bg-white p-5 rounded-2xl border border-[#e0ecf4] shadow-xs space-y-3">
          <div className="flex items-center justify-between border-b border-[#f0f7fb] pb-2">
            <h3 className="text-xs font-bold text-[#082b3d] uppercase tracking-wider flex items-center gap-1.5">
              <span className="material-symbols-outlined text-sm text-[#0e5d84]">event</span>
              <span>Upcoming School Events</span>
            </h3>
            <span className="text-[10px] text-[#777587]">This Month</span>
          </div>

          <div className="space-y-2 text-xs">
            <div className="flex items-start gap-3 p-2 hover:bg-slate-50 rounded-lg">
              <div className="w-10 h-10 rounded-xl bg-[#f0f7fb] text-[#0e5d84] flex flex-col items-center justify-center shrink-0">
                <span className="text-xs font-bold">28</span>
                <span className="text-[8px] uppercase font-bold">Feb</span>
              </div>
              <div>
                <div className="font-bold text-[#082b3d]">CBSE Class 10 PTM Consultations</div>
                <div className="text-[10px] text-[#777587]">Hybrid Mode • In-person & Google Meet</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2 hover:bg-slate-50 rounded-lg">
              ...
              <div>
                <div className="font-bold text-[#082b3d]">Annual Science & Robotics Expo</div>
                <div className="text-[10px] text-[#777587]">Main Auditorium • Inter-School Showcase</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-3 p-2 hover:bg-slate-50 rounded-lg">
              ...
              <div>
                <div className="font-bold text-[#082b3d]">CBSE Board Exam Hall Ticket Distribution</div>
                <div className="text-[10px] text-[#777587]">Principal Class 3 DSC Verification</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-2xs animate-in fade-in">
          <div className="bg-white rounded-2xl max-w-md w-full p-6 shadow-2xl border border-[#cbe0ec] space-y-4">
            <div className="flex items-center justify-between border-b border-[#f0f7fb] pb-3">
              <div>
                <h3 className="font-bold text-base text-[#082b3d]">{selectedReviewItem.title}</h3>
                <span className="text-xs text-[#777587]">Department Category: {selectedReviewItem.category}</span>
              </div>
              <button onClick={() => setSelectedReviewItem(null)} className="text-[#777587] hover:text-[#082b3d]">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
                <div className="text-[#777587] font-semibold">Applicant / Initiator:</div>
                <div className="font-bold text-[#082b3d]">{selectedReviewItem.applicant}</div>
                <div className="text-[11px] text-[#464555]">{selectedReviewItem.details}</div>
              </div>

              <div>
                <label className="block font-bold text-[#464555] mb-1">Detailed Operational Justification</label>
                <div className="p-3 bg-[#f8f9ff] border border-[#cbe0ec] rounded-xl text-[#082b3d] text-xs leading-relaxed">
                  {selectedReviewItem.reason}
                </div>
              </div>

              <div className="p-3 bg-[#f0f7fb] border border-[#cbe0ec] rounded-xl text-[#082b3d] text-[11px] font-medium">
              ...
              <div className="flex justify-between items-center pt-3 border-t border-[#f0f7fb]">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="px-3 py-2 bg-slate-100 hover:bg-slate-200 text-[#082b3d] rounded-xl font-semibold"
                  >
                    Close
                  </button>
                  <button
